    ...
    <footer className="bg-primary text-white py-10">
      <div className="mb-20 container mx-auto px-4 md:px-0 flex flex-col md:flex-row justify-between items-center md:items-start space-y-8 md:space-y-0">
        ...
        <div className="text-center md:text-left">
          <Image
            src="/images/CamCyber_Logo_white.png"
            alt="CamCyber Logo"
            width={150}
            height={50}
        ...
        <div className="text-center md:text-left">
          <h4 className="font-bold mb-4 text-title">ទំនាក់ទំនង</h4>
          <div className="border-t-[1px] border-white w-full mb-4"></div>
          <ul className="space-y-3 text-sm">
            <li className="flex items-center justify-center md:justify-start">
              <FiMail className="mr-2 text-text" /> info@camcyberdigital.com
            </li>
            <li className="flex items-center justify-center md:justify-start">
              <FiPhone className="mr-2 text-text" /> +855 87 955 888
            </li>
            <li className="flex items-center justify-center md:justify-start">
              <FiMapPin className="mr-2 text-text" /> Phnom Penh
            </li>
          </ul>
        </div>
      </div>
